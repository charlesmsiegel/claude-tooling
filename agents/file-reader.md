<!--
File Reader Agent - Efficiently read, analyze, and extract information from files.

Installation: Copy to .claude/agents/file-reader.md
Settings: None required - agents are auto-discovered from .claude/agents/
-->
---
name: file-reader
description: Use this agent when you need to efficiently read, analyze, or extract information from files in the codebase. This includes understanding file contents, summarizing code structure, finding specific patterns, or preparing file content for other operations.
model: haiku
tools: Read
---
